...
<body class="form-v10">
	<div class="page-content">
		<div class="form-v10-content">
			<form class="form-detail" action="insertuserEventBook" method="post" >
				<div class="form-left">
					...
					<div class="form-row">
						<input type="number" name="noofhours"  placeholder="No Of Hours" required>
					</div>
					<div class="form-row">
						<input type="number" name="guestmembers"  placeholder="Total Guest members" required>
					</div>
