...
<div class="flip-card-container" style="--hue: 350">
  <div class="flip-card">
    ...
    <div class="card-front">
      ...
      <ul>
        <li>Event Type :<c:out value="${user.eventtype}" /></li>
        <li>Per Hour cost: <c:out value="${user.cost}" /> Rs</li>
        <li> Facilities : <c:out value="${user.facilities}" /></li>
      <li> Hours : <c:out value="${user.nohours}" /></li>
      </ul>
    </div>
    ...
    <div class="card-back">
      ...
      <button onclick="window.location.href='<%=request.getContextPath()%>/newUserEventBook'" >Book</button>
