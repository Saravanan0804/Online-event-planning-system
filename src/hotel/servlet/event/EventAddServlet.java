...
public class EventAddServlet extends HttpServlet {
	...
	public static final String UPLOAD_DIR = "images"+File.separator+"events";
	public static final String UPLOAD_DIR2="images/events";
...
//	   String savepath ="D:\\Users\\PC\\eclipse-workspace\\Test2\\WebContent\\EventImg"+File.separator+fileName;
...
//	       /images/events/img.pngsssss
	   String imgname=name1;
		Events event = new Events(eventtype, nohours, facilities, cost,imgname,imagePath);
		try {
